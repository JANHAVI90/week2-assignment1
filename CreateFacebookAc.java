...
public class CreateFacebookAc {
	...
	driver.findElement(By.name("reg_email__")).sendKeys("abcd1@gmail.com");
	driver.findElement(By.name("reg_email_confirmation__")).sendKeys("abcd1@gmail.com");
	...
	drpDwn2.selectByVisibleText("1990");
